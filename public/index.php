            ...
            <div id="sign_up_inputs">
                ...
                <div>
                    <label>
                        ...
                        <input id="password" type="password" placeholder="Password" name="password" minlength="8" pattern="^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?!.*\s).*$" title="Minimum of 8 characters, should have at least one uppercase letter and two numbers." required>
                    </label>
                </div>
            </div>
            <div id="button"></div>
